...
====
[start=16]
. link:TL/16_SSH_&_Terminal_commands_Setup_WSL/0.General_Table_of_Contents.adoc[SSH & Terminal commands. Setup WSL]
...
. link:TL/18_Configuring_a_project._Property_files/Configuring_a_project.Property_files_README.md[Configuring a project. Property files.]
. link:TL/19_junit_running_junit_tests/JUnit5%20overview%20and%20running%20JUnit%20tests.adoc[JUnit. Running JUnit tests]
. link:TL/20_Test_Hooks-Before&After/Test_Hooks_Before_&_After_README.adoc[Test hooks - Before & After]
...
. link:TL/22_configuring_&_using_logger/Configuring_&_Using_Logger.adoc[Configure & use logger]
...
. link:TL/26_WebElements_in_Page_Objects_XPath_functions/WebElements_in_Page_Objects.XPath_functions.adoc[WebElements in Page Objects. XPath functions]
...
. link:ST/31_sending_and_validating_API_requests_Configuration_of_API_client/API_requests_and_responces.md[Sending and validating API requests. Configuration of API client.]
...
. link:ST/35_Streams%20&%20lambda%20expressions/Complete_Guide_Streams_Lambda_Expressions_Java_Payments_README.md[Streams & lambda expressions]
