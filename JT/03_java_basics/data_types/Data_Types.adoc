...
image::../resource/String.png[]

TIP: More info about String type you can find https://docs.oracle.com/javase/8/docs/api/java/lang/String.html[here] and some methods examples https://medium.com/edureka/java-string-68e5d0ca331f#:~:text=For%20Example%3A%20String%20s%3D%E2%80%9C,the%20object%20in%20the%20heap.[here].
...
TIP: More info about Class you can find in *'JT/oop_basics/classes'* package
...
TIP: More info about Class you can find in *'JT/oop_basics/objects'* package
...
TIP: More info about Class you can find in *'JT/applied OOP/interface'* package.
